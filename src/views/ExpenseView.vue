    ...
    <v-sheet>
        <v-layout>
            <v-app-bar color="primary" class="gradient-app-bar" prominent>
                ...
                <v-toolbar-title>FinArt</v-toolbar-title>
                            ...
                            <v-row>
                                <v-col cols="8">
                                    ...
                                    <v-card-subtitle class="mx-4"
                                        >Today, 11:24 PM</v-card-subtitle
                                    >
                                </v-col>
                    ...
                    <v-row>
                        <v-col cols="6">
                            <v-card class="mx-2 px-2 py-6">
                                ...
                                ></v-icon>
                                <span
                                    class="text-md-subtitle-1 text-subtitle-2 text-secondary"
                                >
                                    Cash: Rs 133490</span
                                >
                            </v-card>
                        ...
                        <v-col cols="6">
                            <v-card class="mx-2 px-4 py-6">
                                ...
                                ></v-icon>
                                <span
                                    class="text-subtitle-2 text-md-subtitle-1 text-secondary"
                                >
                                    Accounts</span
                                >
                            </v-card>
        ...
        <v-card class="px-2 py-2">
            ...
            <v-form @submit.prevent="createOrUpdateTransaction()">
                ...
                <v-select
                    ...
                    :disabled="form.party_name == '+ Add Party'"
                    variant="solo"
                ></v-select>
                <v-text-field
                    v-if="form.transaction_type == 'Loans & Advances' && form.party_name == '+ Add Party'"
...
const createOrUpdateTransaction = () => {
    axios.post('https://microfin.ritdos.com/api/store/transaction', form)
    .then((response) => {
...
const fetchAPIs = () => {
    axios.get('https://microfin.ritdos.com/api/get/apis')
    .then((response) => {
        console.log(response);
        ...
        populate.parties.push("+ Add Party");
